...
describe('Gestión de posts en Ghost CMS', () => {
    ...
    it('should not allow creating a post with a numeric title', function() {
        const postTitle = faker.datatype.number({ min: 1000000000, max: 9999999999 }).toString(); // Título numérico
        const postDescription = faker.lorem.paragraph();

        cy.log('Attempting to create post with a numeric title');
        ...
        // Intentar ingresar un título numérico y capturar el error esperado
        ...
        cy.screenshot('ss_create_post_description_entered_numeric_title', {
            capture: 'viewport',
            clip: { x: 0, y: 0, width: 1000, height: 660 }
        });

        // Intentar publicar el post y verificar que no se permite

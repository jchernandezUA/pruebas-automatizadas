...
Scenario: Como usuario inicio sesión, agrego un post y le agrego un tag al post
  ...
  When I add a new tag named "<tag_fail>" "add_tag_post" "06"
  Then I verify the tag error "add_tag_post" "07"
  ...
  #https://api.mockaroo.com/api/d4c2aec0?count=5&key=86bc46c0